...
class CredentialOfferCreator {
  ...
  companion object {
    fun create(
      ...
      if (grantsObject == null) {
        return org.idp.wallet.verifiable_credentials_library.domain.verifiable_credentials
            .CredentialOffer(credentialIssuer, credentialConfigurationIds)
      }
      val preAuthorizedCodeGrant =
          org.idp.wallet.verifiable_credentials_library.domain.verifiable_credentials
              ...
              .Companion
              .toPreAuthorizedGrant(grantsObject)
      val authorizedCodeGrant =
          org.idp.wallet.verifiable_credentials_library.domain.verifiable_credentials
              .CredentialOfferCreator
              .Companion
              .toAuthorizationCodeGrant(grantsObject)
      return org.idp.wallet.verifiable_credentials_library.domain.verifiable_credentials
          .CredentialOffer(
    ...
    private fun toAuthorizationCodeGrant(
        jsonObject: JSONObject
      ...
      try {
        ...
        return org.idp.wallet.verifiable_credentials_library.domain.verifiable_credentials
            .AuthorizedCodeGrant(issuerState, authorizationServer)
      } catch (e: Exception) {
        return null
      }
    }

    private fun toPreAuthorizedGrant(
        jsonObject: JSONObject
