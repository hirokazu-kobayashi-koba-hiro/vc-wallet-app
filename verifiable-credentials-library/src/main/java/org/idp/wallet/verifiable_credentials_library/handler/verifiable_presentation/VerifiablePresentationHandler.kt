...
import org.idp.wallet.verifiable_credentials_library.verifiable_presentation.VerifiablePresentationRequestCreator
...
class VerifiablePresentationHandler(
  ...
  suspend fun handleVpRequest(url: String): VerifiableCredentialsRecords {
    ...
    val filterVerifiableCredential = presentationRequest.filterVerifiableCredential(records)
  ...
  private suspend fun extractRequestObject(url: String): JwtObject {
    ...
    throw RuntimeException(
        "Authorization request does not contain request object. Authorization request must contain either request or request_uri.")
  }
}
